package com.spring.backend.common.config.datasource;

import com.spring.backend.common.config.datasource.marker.PostgresMapper;
...
@RefreshScope
@Configuration
@MapperScan(basePackages = "com.spring.backend",
