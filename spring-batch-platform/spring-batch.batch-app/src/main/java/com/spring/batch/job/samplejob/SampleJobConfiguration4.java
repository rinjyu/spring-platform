...
public class SampleJobConfiguration4 {

    private static final String JOB_NAME = "sampleJob4";
    private static final String STEP_NAME_PREFIX = "sampleJob4_step";
