...
public class SampleJobConfiguration5 {

    private static final String JOB_NAME = "sampleJob5";
    private static final String STEP_NAME_PREFIX = "sampleJob5_step";

    private final JobBuilderFactory jobBuilderFactory;
    private final StepBuilderFactory stepBuilderFactory;

    @Bean(name = JOB_NAME)
    public Job sampleJob5() {
        return jobBuilderFactory.get(JOB_NAME)
                .start(sampleJob5_step())
