...
public class SimpleFlowJobConfiguration2 {
    ...
    private static final String JOB_NAME = "simpleFlowJob2";
    private static final String STEP_NAME = "simpleFlowJob2_step";
    private static final String FLOW_NAME = "simpleFlowJob2_flow";
    ...
    public Step simpleFlowJob2_step1() {
        return stepBuilderFactory.get(STEP_NAME + "1")
                .tasklet((contribution, chunkContext) -> {
                    log.debug(">> simpleFlowJob2_step1 <<");
    ...
    public Step simpleFlowJob2_step2() {
        return stepBuilderFactory.get(STEP_NAME + "2")
                .tasklet((contribution, chunkContext) -> {
                    log.debug(">> simpleFlowJob2_step2 <<");
                    return RepeatStatus.FINISHED;
                }).build();
    }
    ...
    public Step simpleFlowJob2_step3() {
        return stepBuilderFactory.get(STEP_NAME + "3")
                .tasklet((contribution, chunkContext) -> {
                    log.debug(">> simpleFlowJob2_step3 <<");
                    return RepeatStatus.FINISHED;
                }).build();
    }
    ...
    public Step simpleFlowJob2_step4() {
        return stepBuilderFactory.get(STEP_NAME + "4")
                .tasklet((contribution, chunkContext) -> {
                    log.debug(">> simpleFlowJob2_step4 <<");
                    return RepeatStatus.FINISHED;
                }).build();
    }
    ...
    public Step simpleFlowJob2_step5() {
        return stepBuilderFactory.get(STEP_NAME + "5")
                .tasklet((contribution, chunkContext) -> {
                    log.debug(">> simpleFlowJob2_step5 <<");
                    return RepeatStatus.FINISHED;
                }).build();
    }
    ...
    public Step simpleFlowJob2_step6() {
        return stepBuilderFactory.get(STEP_NAME + "6")
                .tasklet((contribution, chunkContext) -> {
                    log.debug(">> simpleFlowJob2_step6 <<");
                    return RepeatStatus.FINISHED;
                }).build();
    }
}
